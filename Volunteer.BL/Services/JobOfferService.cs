...
namespace Volunteer.BL.Services
{
    public class JobOfferService : IJobOfferService
    {
        ...
        public async Task<CreateJobOfferDTO> CreateJobOffer(Guid organizationId, CreateJobOfferDTO jobOfferDTO)
        {
            ...
            {
                Id = Guid.NewGuid(),//can be autogenerated by db, but I am OK with that
        ...
        {
            var jobOffer = await _dbContext.JobOffer
                .Include(x => x.Organization)
                .FirstOrDefaultAsync(i => i.Id == id);
            var organization = await _dbContext.Organizations//you don't need this call, OrganizationId and OrganizationName are already in jobOffer, just need to include it 
            ...
            return new ShowJobOfferDTO
            {
                ...
                OrganizationId = jobOffer.OrganizationId,
                OrganizationName = jobOffer.Organization.Name
            };
        }
        ...
        {
            var now = DateTime.Now;//better use DateTime.UtcNow. it may cause issues with running api in different availability/time zones
