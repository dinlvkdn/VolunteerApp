...
namespace Volunteer.DAL.Migrations
{
    ...
    [Migration("20240313123022_AddedNewTableVolunteerDetailsAndDeletedColumnsFromVolunteer")]
    partial class AddedNewTableVolunteerDetailsAndDeletedColumnsFromVolunteer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Volunteer.DAL.Models.OrganizationDetails", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Volunteer.DAL.Models.VolunteerDetails", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Volunteer.DAL.Models.OrganizationDetails", b =>
                {
                    b.HasOne("Volunteer.DAL.Models.Organization", "Organization")
                        ...
                        .HasForeignKey("Volunteer.DAL.Models.OrganizationDetails", "OrganizationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Volunteer.DAL.Models.VolunteerDetails", b =>
                {
                    b.HasOne("Volunteer.DAL.Models.Volunteer", "Volunteer")
                        ...
                        .HasForeignKey("Volunteer.DAL.Models.VolunteerDetails", "VolunteerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
